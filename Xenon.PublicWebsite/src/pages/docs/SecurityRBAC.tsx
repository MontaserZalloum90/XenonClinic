...
const roles = [
  {
    ...
    level: "System",
    permissions: 52,
    description: "Full platform access, system configuration, all tenants",
    dataAccess: "All data across all tenants",
    canAccessPHI: true,
  },
  {
    name: "Tenant Admin",
    ...
    level: "Tenant",
    permissions: 35,
    description: "Tenant-level administration, user management",
    dataAccess: "All data within assigned tenant",
    canAccessPHI: true,
  },
  {
    name: "Doctor",
    ...
    level: "Clinical",
    permissions: 25,
    description: "Patient care, diagnosis, prescriptions, orders",
    dataAccess: "Assigned patients, clinical records",
    canAccessPHI: true,
  },
  {
    name: "Nurse",
    ...
    level: "Clinical",
    permissions: 18,
    description: "Patient intake, vitals, clinical support",
    dataAccess: "Assigned patients, limited clinical",
    canAccessPHI: true,
  },
  {
    name: "Receptionist",
    ...
    level: "Front Office",
    permissions: 12,
    description: "Scheduling, check-in, basic patient info",
    dataAccess: "Demographics, appointments only",
    canAccessPHI: false,
  },
  {
    name: "Lab Technician",
    ...
    level: "Clinical",
    permissions: 8,
    description: "Lab orders, specimens, results entry",
    dataAccess: "Lab orders and results only",
    canAccessPHI: true,
  },
  {
    name: "Pharmacist",
    ...
    level: "Clinical",
    permissions: 12,
    description: "Prescription verification, dispensing",
    dataAccess: "Prescriptions, medication history",
    canAccessPHI: true,
  },
  {
    name: "Radiologist",
    ...
    level: "Clinical",
    permissions: 8,
    description: "Image interpretation, reporting",
    dataAccess: "Imaging orders and studies",
    canAccessPHI: true,
  },
  {
    name: "HR Manager",
    ...
    dataAccess: "Employee records, no patient data",
    canAccessPHI: false,
  },
  {
    name: "Accountant",
    ...
    level: "Business",
    permissions: 8,
    description: "Billing, claims, financial reporting",
    dataAccess: "Financial records, limited patient",
    canAccessPHI: false,
  },
  {
    name: "Audiologist",
    ...
    level: "Clinical",
    permissions: 8,
    description: "Hearing assessments, device fitting",
    dataAccess: "Audiology records only",
    canAccessPHI: true,
  },
  {
    name: "Patient",
...
const allPermissions = [
  // Patient Management
  {
    ...
    description: "View patient demographics and basic info",
  ...
  },
  {
    ...
    description: "Delete/deactivate patients",
    category: "Patient Management",
    isPHI: true,
  },
  {
  ...
  {
    permission: "patients:medical_history",
  ...
  // Clinical
  {
    permission: "clinical_visits:view",
    description: "View clinical encounters",
    category: "Clinical",
    isPHI: true,
  },
  {
    permission: "clinical_visits:create",
    description: "Create clinical encounters",
    category: "Clinical",
    isPHI: true,
  },
  {
    permission: "clinical_visits:update",
    description: "Update clinical documentation",
    category: "Clinical",
    isPHI: true,
  },
  {
    permission: "clinical_visits:sign",
    description: "Sign and finalize visits",
    category: "Clinical",
    isPHI: true,
  },
  {
    permission: "clinical_visits:amend",
    description: "Amend signed records",
    category: "Clinical",
    isPHI: true,
  },
  {
  ...
  {
    permission: "prescriptions:controlled",
    description: "Prescribe controlled substances",
    category: "Clinical",
    isPHI: true,
  },
  // Laboratory
  ...
  },
  {
    ...
    description: "Update lab orders/results",
    category: "Laboratory",
    isPHI: true,
  },
  {
    permission: "lab:approve",
    description: "Approve and release results",
    category: "Laboratory",
    isPHI: true,
  },
  {
    permission: "lab:qc",
    description: "Access quality control",
    category: "Laboratory",
    isPHI: false,
  },
  // Radiology
  {
    ...
    description: "View imaging orders",
    category: "Radiology",
    isPHI: true,
  },
  {
    permission: "radiology:create",
    description: "Create imaging orders",
    category: "Radiology",
    isPHI: true,
  },
  {
  ...
  {
    permission: "radiology:approve",
    description: "Sign radiology reports",
    category: "Radiology",
    isPHI: true,
  },
  // Pharmacy
  {
    ...
    description: "View pharmacy queue",
    category: "Pharmacy",
    isPHI: true,
  },
  {
  ...
  {
    permission: "pharmacy:controlled",
    description: "Handle controlled substances",
    category: "Pharmacy",
    isPHI: true,
  },
  // Financial
  ...
  },
  {
    ...
    description: "Approve refunds/adjustments",
    category: "Financial",
    isPHI: false,
  },
  {
...
const dataClassifications = [
  {
    ...
    examples: "Clinic hours, general policies, public announcements",
    handling: "Can be freely shared",
  },
  {
    level: "Internal",
    color: "bg-blue-100 text-blue-800",
    description: "Internal business information",
    examples: "Staff schedules, internal memos, operational procedures",
    handling: "Share within organization only",
  },
  {
    level: "Confidential",
    color: "bg-yellow-100 text-yellow-800",
    description: "Sensitive business data",
    examples: "Financial reports, vendor contracts, employee records",
    handling: "Need-to-know basis, encrypted storage",
  },
  {
    level: "PHI/Restricted",
    color: "bg-red-100 text-red-800",
    description: "Protected Health Information",
    examples: "Patient records, diagnoses, lab results, prescriptions",
    handling: "HIPAA compliant, encrypted, audit logged",
  },
];
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-lg text-gray-600">
          XenonClinic implements comprehensive Role-Based Access Control (RBAC)
          with enterprise-grade security features for healthcare compliance, PHI
          protection, and regulatory requirements across multiple jurisdictions.
        </p>
      </div>
                ...
                <table className="min-w-full divide-y divide-gray-200 text-sm">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {[
                      {
                        event: "LOGIN_SUCCESS",
                        desc: "Successful user authentication",
                        level: "Info",
                      },
                      {
                        event: "LOGIN_FAILED",
                      ...
                      {
                        event: "PHI_ACCESS",
                        desc: "Patient health information accessed",
                        level: "Info",
                      },
                      {
                        event: "PHI_EXPORT",
                        desc: "Patient data exported",
                        level: "Warning",
                      },
                      {
                        event: "BREAK_GLASS",
                        desc: "Emergency access to restricted records",
                        level: "Critical",
                      },
                      {
                        event: "PERMISSION_CHANGE",
                        desc: "User permissions modified",
                        level: "Warning",
                      },
                      {
                        event: "ACCOUNT_LOCKED",
                        desc: "Account locked due to failed attempts",
                        level: "Warning",
                      },
                      {
                        event: "CONFIG_CHANGE",
                        desc: "System configuration modified",
                        level: "Info",
                      },
                      {
                        event: "DATA_DELETE",
                        desc: "Record deletion event",
                        level: "Warning",
                      },
                      {
                        event: "BULK_EXPORT",
                        desc: "Large data export initiated",
                        level: "Critical",
                      },
                    ].map((row) => (
                      <tr key={row.event}>
          ...
          <div className="mt-4 space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2">
                    In emergency situations, authorized clinical staff can
                    access patient records beyond their normal scope. This
                    feature ensures patient safety while maintaining
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <div className="flex flex-wrap items-center gap-2 text-sm">
                ...
                <span className="text-gray-400">→</span>
                <span className="px-3 py-2 bg-red-100 text-red-700 rounded-lg">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5">
              ...
              <ul className="space-y-1 text-sm text-gray-700">
                <li>
                  • All Break the Glass events are flagged for mandatory review
                </li>
                ...
                <li>
                  • Monthly Break the Glass reports generated automatically
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">
              Role-specific guides and permissions
            </p>
          </Link>
          <Link
