...
const endpointGroups: EndpointGroup[] = [
  ...
  },
  {
    ...
    base: "/api/patients",
    description:
      "Patient registration, profile management, and medical records",
    endpoints: [
      {
        method: "GET",
        path: "/",
        ...
        parameters: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "Search by name, MRN, phone, or Emirates ID",
          },
          {
            name: "status",
            type: "string",
            required: false,
            description: "Filter by status: active, inactive, deceased",
          },
          {
            name: "sortBy",
            type: "string",
            required: false,
            description: "Sort field: name, createdAt, lastVisit",
          },
          {
            name: "sortOrder",
            type: "string",
  ...
  "emergencyContact": {
    ...
    "phone": "+971507654321"
      ...
      },
      {
        ...
        description:
          "Get patient medical history (allergies, conditions, surgeries)",
    ...
    endpoints: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "scheduled, checked-in, completed, cancelled, no-show",
          },
          {
            name: "departmentId",
            type: "uuid",
  ...
  },
  {
    ...
    description:
      "Clinical encounter documentation, vitals, diagnoses, and prescriptions",
    endpoints: [
      {
        method: "GET",
        path: "/",
  ...
  },
  {
    ...
    base: "/api/laboratory",
    description:
      "Lab order management, specimen tracking, and result reporting",
    endpoints: [
      {
        method: "GET",
        path: "/orders",
  ...
  },
  {
    ...
    base: "/api/pharmacy",
    description:
      "Prescription management, medication dispensing, and inventory",
    endpoints: [
      {
        method: "GET",
        path: "/prescriptions",
...
function EndpointCard({
  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      ...
      >
        <span
          className={`px-2 py-0.5 rounded text-xs font-medium ${methodColors[endpoint.method]}`}
        >
          {endpoint.method}
        </span>
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-lg text-gray-600">
          XenonClinic provides a comprehensive REST API for integration with
          external systems. This documentation covers all available endpoints,
...
https://sandbox-api.yourcompany.xenonclinic.com/v1`}
        ...
        <p className="text-sm text-gray-500 mt-2">
          Replace <code className="bg-gray-100 px-1 rounded">yourcompany</code>{" "}
      ...
      <section>
        ...
        <div className="space-y-4">
          <p className="text-gray-600">
            ...
            header. Tokens are obtained by authenticating with user credentials.
          </p>
          <CodeBlock
            code={`# 1. Obtain Token
POST /api/auth/login
  ...
  "refreshToken": "dGhpcyBpcyBhIHJlZnJlc2ggdG9rZW4..."
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          All API responses follow a consistent JSON structure for easy parsing
          and error handling.
        </p>
    ...
    "hasPreviousPage": false
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr>
                ...
                <td className="px-4 py-3 font-medium">OK</td>
                <td className="px-4 py-3 text-gray-600">Request successful</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-green-600">201</td>
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-green-600">204</td>
                <td className="px-4 py-3 font-medium">No Content</td>
                <td className="px-4 py-3 text-gray-600">
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-red-600">401</td>
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-red-600">403</td>
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-red-600">404</td>
              ...
              <tr>
                <td className="px-4 py-3 font-mono text-red-600">409</td>
                <td className="px-4 py-3 font-medium">Conflict</td>
                <td className="px-4 py-3 text-gray-600">
                  Resource conflict (duplicate, version mismatch)
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-red-600">422</td>
                <td className="px-4 py-3 font-medium">Unprocessable</td>
                <td className="px-4 py-3 text-gray-600">
                  Business logic validation failed
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-red-600">429</td>
              ...
              <tr>
                ...
                <td className="px-4 py-3 font-medium">Server Error</td>
                <td className="px-4 py-3 text-gray-600">
                  Unexpected server error, contact support
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-red-600">503</td>
                <td className="px-4 py-3 font-medium">Service Unavailable</td>
                <td className="px-4 py-3 text-gray-600">
                  System maintenance or overload
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Default limit: 100 requests/minute. Contact support for higher
                limits.
              </p>
            </div>
          </div>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-6">
          Click on any endpoint group to expand and view detailed documentation
          for each endpoint. Total endpoints:{" "}
          <strong>
            {endpointGroups.reduce((acc, g) => acc + g.endpoints.length, 0)}+
          </strong>
        </p>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          XenonClinic can send real-time notifications to your systems when
          events occur. Configure webhook endpoints in Admin Settings.
        </p>
        <div className="bg-white border border-gray-200 rounded-xl p-5">
      ...
      <section className="bg-primary-50 border border-primary-200 rounded-xl p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Access the full Swagger/OpenAPI documentation for testing
              endpoints directly in your browser. The interactive documentation
              includes request builders and live API testing.
            </p>
            ...
            <p className="text-sm text-gray-500 mt-3">
              Replace <code className="bg-white px-1 rounded">yourcompany</code>{" "}
              with your organization's subdomain.
            </p>
          </div>
        </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm text-gray-600">
              <li>
                Email:{" "}
                <a
                  href="mailto:api-support@xenonclinic.com"
                  className="text-primary-600 hover:underline"
                >
                  api-support@xenonclinic.com
                </a>
              </li>
              <li>
                Developer Portal:{" "}
                <a
                  href="https://developers.xenonclinic.com"
                  className="text-primary-600 hover:underline"
                >
                  developers.xenonclinic.com
                </a>
              </li>
              <li>
                Status Page:{" "}
                <a
                  href="https://status.xenonclinic.com"
                  className="text-primary-600 hover:underline"
                >
                  status.xenonclinic.com
                </a>
              </li>
            </ul>
          </div>
