...
export const OrthopedicExams = () => {
  ...
  const [selectedExam, setSelectedExam] = useState<OrthopedicExam | undefined>(
    undefined,
  );
      ...
      <div className="flex items-center justify-between animate-fade-in">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            {t("page.orthopedicExams.title", "Orthopedic Exams")}
          </h1>
          <p className="text-gray-600 mt-1">
            {t(
              "page.orthopedicExams.description",
              "Manage orthopedic examinations",
            )}
          </p>
        </div>
      ...
      <div className="card animate-fade-in">
        <div className="mb-4">
          <input
            ...
            placeholder={t(
              "field.search",
              "Search by patient, complaint, area, or diagnosis...",
            )}
            value={searchTerm}
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8 text-gray-500">
            {searchTerm
              ? t("message.noResults", "No exams found matching your search.")
              : t("message.noExams", "No exams recorded yet.")}
          </div>
        )}
      </div>
                    ...
                    <input
                      ...
                      defaultValue={
                        selectedExam?.examDate
                          ? format(
                              new Date(selectedExam.examDate),
                              "yyyy-MM-dd",
                            )
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 mt-1">
                        {selectedExam.patientName ||
                          `Patient #${selectedExam.patientId}`}
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700">
