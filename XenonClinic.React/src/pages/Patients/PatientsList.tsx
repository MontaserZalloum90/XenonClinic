...
export const PatientsList = () => {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      showToast(
        "success",
        t("message.success.deleted", "Patient deleted successfully"),
      );
    },
    onError: (error: Error) => {
      showToast(
        "error",
        `${t("action.delete", "Delete")} ${t("message.error.generic", "failed")}: ${error.message}`,
      );
    },
  });
  ...
  const bulkDeleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      showToast(
        "success",
        t("message.success.deleted", "Selected patients deleted successfully"),
      );
    },
    onError: (error: Error) => {
      showToast(
  ...
  const handleFormSuccess = () => {
    ...
    showToast(
      "success",
      selectedPatient
        ? t("message.success.updated", "Patient updated successfully")
        : t("message.success.created", "Patient created successfully"),
    );
  };
  ...
  const handleBulkDelete = () => {
    showConfirm(
      ...
      t(
        "message.confirm.deleteMultiple",
  ...
  const exportColumns: ExportColumn[] = [
    ...
    {
      key: "dateOfBirth",
      label: t("field.dateOfBirth", "Date of Birth"),
    ...
    { key: "age", label: t("field.age", "Age") },
    {
      ...
      format: (v) =>
        v === "M" ? t("field.male", "Male") : t("field.female", "Female"),
    },
  ...
  const handleExportCSV = () => {
    ...
    showToast(
      "success",
      t("message.success.exported", "Patients exported to CSV"),
    );
  };
  ...
  const handleExportExcel = () => {
    ...
    showToast(
      "success",
      t("message.success.exported", "Patients exported to Excel"),
    );
  };
  ...
  const handlePrint = () => {
    printTable(
      prepareExportData(),
      exportColumns,
      t("entity.patient.plural", "Patients List"),
    );
    setShowExportMenu(false);
  };
    ...
    return (
      <div className="p-4 bg-red-50 border border-red-200 rounded-md animate-fade-in">
        <p className="text-sm text-red-600">
          {t("message.error.loading", "Error loading patients")}:{" "}
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between animate-fade-in">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            {t("entity.patient.plural", "Patients")}
          </h1>
      ...
      {recentItems.length > 0 && (
        <div className="card animate-fade-in">
          <h3 className="text-sm font-medium text-gray-700 mb-3">
            {t("page.patients.recentlyViewed", "Recently Viewed")}
          </h3>
      ...
      <div className="card animate-fade-in">
        ...
        <div className="relative">
          <input
            ...
            placeholder={t(
              ...
              "Search by name, Emirates ID, phone, or email...",
            )}
          />
          <svg
        ...
        <p className="text-xs text-gray-500 mt-2">
          ...
          {t("shortcuts.toFocusSearch", "to focus search")}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          {
            label: `${t("stats.total", "Total")} ${t("entity.patient.plural", "Patients")}`,
            value: patients?.length || 0,
            color: "text-gray-900",
          },
          {
            label: t("field.male", "Male"),
            value: patients?.filter((p) => p.gender === "M").length || 0,
            color: "text-blue-600",
          },
          {
            label: t("field.female", "Female"),
            value: patients?.filter((p) => p.gender === "F").length || 0,
            color: "text-pink-600",
          },
          {
            label: t("table.searchResults", "Search Results"),
      ...
      <div className="card overflow-hidden p-0 animate-fade-in">
        {isLoading ? (
          ...
          <EmptyState
            ...
            title={
              searchTerm
                ? t("message.noResults", "No patients found")
                : t("message.emptyList", "No patients yet")
            }
            description={
              searchTerm
                ? t("message.searchTip", "Try adjusting your search criteria")
                : t(
                    "message.getStarted",
      ...
      <div className="text-xs text-gray-500 animate-fade-in">
        <strong>{t("shortcuts.title", "Keyboard shortcuts")}:</strong>{" "}
        ...
        {t("shortcuts.refresh", "Refresh")},{" "}
        <kbd className="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded">
          Delete
        </kbd>{" "}
        {t("shortcuts.delete", "Delete selected")}
      </div>
      ...
      <Modal
        ...
        title={
          selectedPatient
            ? t("page.patients.edit", "Edit Patient")
            : t("page.patients.add", "New Patient")
        }
        size="lg"
      >
