      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Track and manage pregnancy records
          </p>
        </div>
        <button
                ...
                {filteredPregnancies.map((pregnancy) => (
                  <tr key={pregnancy.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(pregnancy.status)}`}
                      >
                    ...
                    <td className="px-4 py-3 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => {
                            if (
                              window.confirm("Delete this pregnancy record?")
                            ) {
