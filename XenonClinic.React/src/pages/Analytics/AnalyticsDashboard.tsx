...
export const AnalyticsDashboardPage = () => {
  ...
  const { data: recentReports } = useQuery<Report[]>({
    ...
    queryFn: async () => {
      const response = await api.get("/api/AnalyticsApi/reports/recent", {
        params: { limit: 5 },
      });
      return response.data;
    },
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between animate-fade-in">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            {t("nav.analytics", "Analytics Dashboard")}
          </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card animate-fade-in">
          ...
          ) : dashboardData?.appointmentsByDay &&
            dashboardData.appointmentsByDay.length > 0 ? (
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={dashboardData.appointmentsByDay}>
                ...
                <Line
                  ...
                  stroke="#3B82F6"
                  strokeWidth={2}
                  name={t("field.appointments", "Appointments")}
                />
              </LineChart>
            </ResponsiveContainer>
          ) : (
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={dashboardData.revenueByMonth}>
                ...
                <Bar
                  dataKey="revenue"
                  fill="#10B981"
                  name={t("field.revenue", "Revenue (AED)")}
                />
              </BarChart>
            </ResponsiveContainer>
          ) : (
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={dashboardData.departmentStats}>
                ...
                <Bar
                  ...
                  fill="#8B5CF6"
                  name={t("field.patients", "Patients")}
                />
                <Bar
