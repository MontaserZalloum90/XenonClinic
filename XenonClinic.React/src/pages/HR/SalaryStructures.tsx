      ...
      <div className="card">
        ...
        {isLoading ? (
                ...
                {filteredStructures.map((structure) => (
                  <tr key={structure.id} className="hover:bg-gray-50">
                    <td className="px-4 py-3">
                      ...
                      {structure.employeeCount !== undefined &&
                        structure.employeeCount > 0 && (
                          <div className="text-xs text-gray-500">
                            {structure.employeeCount} employees
                          </div>
                        )}
                    </td>
          ...
          <div className="text-center py-8 text-gray-500">
            {searchTerm
              ? "No salary structures found matching your search."
...
const SalaryStructureForm = ({
  ...
  const [formData, setFormData] = useState<SalaryStructureFormData>({
    ...
    effectiveDate:
      structure?.effectiveDate || new Date().toISOString().split("T")[0],
