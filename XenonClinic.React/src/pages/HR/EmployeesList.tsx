...
import { hrApi, payrollApi } from "../../lib/api";
...
export const EmployeesList = () => {
  ...
  const [isPayrollHistoryModalOpen, setIsPayrollHistoryModalOpen] =
    useState(false);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Detailed employee records and management
          </p>
        </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-block px-2 py-1 rounded-full text-xs font-medium mt-1 ${getStatusColor(selectedEmployee.status)}`}
                      >
                    ...
                    {selectedEmployee.salary && (
                      <div>
                        ...
                        <p className="text-sm text-gray-900 mt-1">
                          AED {selectedEmployee.salary.toFixed(2)}
                        </p>
                      </div>
                    )}
      ...
      <Dialog
        open={isPayrollHistoryModalOpen}
        onClose={handleModalClose}
        className="relative z-50"
      >
        <div className="fixed inset-0 bg-black/30" aria-hidden="true" />
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {employeePayrollHistory.map((record) => (
                        <tr key={record.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 text-sm">
                            <span
                              className={`px-2 py-1 rounded-full text-xs font-medium ${getPayrollStatusColor(record.status)}`}
                            >
                          ...
                          <td className="px-4 py-3 text-sm text-gray-600">
                            {record.paidDate
                              ? format(new Date(record.paidDate), "MMM d, yyyy")
                              : "-"}
                          </td>
                        </tr>
                      ))}
