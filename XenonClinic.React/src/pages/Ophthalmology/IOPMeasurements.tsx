...
export const IOPMeasurements = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({
      ...
      id: number;
      data: Partial<CreateIOPMeasurementRequest>;
  ...
  const handleDelete = (measurement: IOPMeasurement) => {
    if (
      window.confirm("Are you sure you want to delete this IOP measurement?")
    ) {
  ...
  const filteredMeasurements = measurements?.filter(
    (measurement) =>
      measurement.patient?.fullNameEn
        .toLowerCase()
  ...
  const getIOPStatus = (iop: number) => {
    ...
    if (iop <= 25)
      return { label: "Borderline", color: "text-yellow-600 bg-yellow-100" };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setFormData({ ...formData, method: e.target.value as IOPMethod })
            }
            className="input w-full"
          >
            <option value={IOPMethodEnum.GoldmannApplanation}>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                rightEye: parseFloat(e.target.value) || 0,
              })
            }
            className="input w-full"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                leftEye: parseFloat(e.target.value) || 0,
              })
            }
            className="input w-full"
          />
