...
export const FundusExams = () => {
  ...
  const [selectedExam, setSelectedExam] = useState<FundusExam | undefined>(
    undefined,
  );
  ...
  const updateMutation = useMutation({
    mutationFn: ({
      ...
      id: number;
      data: Partial<CreateFundusExamRequest>;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Posterior segment and retinal examination records
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, rightEyeFindings: e.target.value })
            }
            className="input w-full"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, leftEyeFindings: e.target.value })
            }
            className="input w-full"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, opticDisc: e.target.value })
            }
            className="input w-full"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, macula: e.target.value })
            }
            className="input w-full"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, vessels: e.target.value })
            }
            className="input w-full"
