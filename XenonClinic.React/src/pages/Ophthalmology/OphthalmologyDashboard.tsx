...
const ophthalmologyApi = {
  getStatistics: () =>
    Promise.resolve({
      data: {
        totalPatients: 342,
        visualAcuityTestsThisMonth: 89,
        refractionTestsThisMonth: 76,
        iopMeasurementsThisMonth: 124,
        slitLampExamsThisMonth: 45,
        fundusExamsThisMonth: 38,
        prescriptionsThisMonth: 62,
        activePrescriptions: 428,
        expiringPrescriptionsSoon: 12,
        highIOPCases: 8,
        recentExams: 23,
        monthlyRevenue: 45000,
      } as OphthalmologyStatistics,
    }),
};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Ophthalmology Dashboard</h1>
          <p className="text-gray-600 mt-1">Eye care and vision management overview</p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats?.recentExams || 0}</p>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  {stats && stats.highIOPCases && stats.highIOPCases > 0 && (
                    <p className="text-xs text-red-600 mt-1">{stats.highIOPCases} high IOP</p>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-blue-600">{stats?.visualAcuityTestsThisMonth || 0}</p>
                <p className="text-sm text-gray-600 mt-1">Visual Acuity Tests</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-purple-600">{stats?.refractionTestsThisMonth || 0}</p>
                <p className="text-sm text-gray-600 mt-1">Refraction Tests</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-indigo-600">{stats?.iopMeasurementsThisMonth || 0}</p>
                <p className="text-sm text-gray-600 mt-1">IOP Measurements</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-teal-600">{stats?.slitLampExamsThisMonth || 0}</p>
                <p className="text-sm text-gray-600 mt-1">Slit Lamp Exams</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-cyan-600">{stats?.fundusExamsThisMonth || 0}</p>
                <p className="text-sm text-gray-600 mt-1">Fundus Exams</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-green-600">{stats?.prescriptionsThisMonth || 0}</p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Refraction Tests</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">IOP Measurements</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Slit Lamp Exams</span>
              </a>
              ...
              >
                <EyeIcon className="h-8 w-8 text-primary-600 mb-2" />
                <span className="text-sm font-medium text-gray-900">Fundus Exams</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900">Glasses Prescriptions</span>
              </a>
            </div>
          </div>

          {/* Alerts */}
          {stats && (stats.expiringPrescriptionsSoon > 0 || (stats.highIOPCases && stats.highIOPCases > 0)) && (
              ...
              <div className="space-y-2">
                {stats.expiringPrescriptionsSoon > 0 && (
                  <div className="flex items-center text-yellow-800">
                    ...
                    <span>
                      {stats.expiringPrescriptionsSoon} prescription(s) expiring within 30 days
                    </span>
                  </div>
                )}
                {stats.highIOPCases && stats.highIOPCases > 0 && (
                  <div className="flex items-center text-red-800">
                    ...
                    <span>{stats.highIOPCases} patient(s) with elevated IOP (&gt;21 mmHg)</span>
                  </div>
                )}
              </div>
            </div>
