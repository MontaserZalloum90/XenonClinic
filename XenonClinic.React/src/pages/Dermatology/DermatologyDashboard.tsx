    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Overview of dermatology services and patient care
        </p>
      </div>
      ...
      {stats?.riskLevelDistribution && (
        <div className="card">
          ...
          <div className="space-y-3">
            {Object.entries(stats.riskLevelDistribution).map(
              ([level, count]) => (
