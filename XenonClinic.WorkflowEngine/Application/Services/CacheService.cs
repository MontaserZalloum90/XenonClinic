...
// Note: CachedProcessDefinitionService removed - the current IProcessDefinitionService interface
// uses DTOs (ProcessDefinitionDetailDto, etc.) rather than entities, requiring a rewrite of the
// caching decorator. For now, caching can be implemented at the application layer using
// InMemoryWorkflowCacheService directly.
