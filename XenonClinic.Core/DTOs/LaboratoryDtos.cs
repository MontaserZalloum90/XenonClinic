...
/// NOTE: BranchId, OrderNumber, OrderDate, and Status may be set by service layer.
/// </summary>
public class CreateLabOrderDto
{
    ...
    /// <summary>
    /// FIX: Order number. If not provided, will be auto-generated by service.
    /// </summary>
    public string? OrderNumber { get; set; }

    /// <summary>
    /// FIX: Order date. Defaults to current date if not provided.
    /// </summary>
    public DateTime OrderDate { get; set; } = DateTime.UtcNow;

    /// <summary>
    /// FIX: Order status. Defaults to Pending.
    /// </summary>
    ...
    /// <summary>
    /// FIX: Who ordered the tests.
    /// </summary>
    public string? OrderedBy { get; set; }

    /// <summary>
    /// FIX: When samples were collected.
    /// </summary>
    public DateTime? CollectionDate { get; set; }

    /// <summary>
    /// FIX: Who collected the samples.
    /// </summary>
    public string? CollectedBy { get; set; }
    ...
    /// <summary>
    /// FIX: Total amount for the lab order.
    /// </summary>
    public decimal TotalAmount { get; set; }

    /// <summary>
    /// FIX: Payment status. Defaults to false.
    /// </summary>
...
public class UpdateLabOrderDto
{
    ...
    /// <summary>
    /// FIX: Allow patient changes for corrections.
    /// </summary>
    public int? PatientId { get; set; }

    /// <summary>
    /// FIX: Allow branch changes for corrections.
    /// </summary>
    public int? BranchId { get; set; }
