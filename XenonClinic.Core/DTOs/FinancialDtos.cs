...
/// NOTE: BranchId, InvoiceNumber, and InvoiceDate may be set by service layer.
/// </summary>
public class CreateInvoiceDto
{
    ...
    /// <summary>
    /// Invoice number. If not provided, will be auto-generated by service.
    /// </summary>
    ...
    /// <summary>
    /// Tax amount. Computed from SubTotal and TaxPercentage if not provided.
    /// </summary>
    public decimal? TaxAmount { get; set; }

    /// <summary>
    /// Total amount. Computed if not provided.
    /// </summary>
    public decimal TotalAmount { get; set; }

    /// <summary>
    /// Paid amount. Defaults to 0.
    /// </summary>
